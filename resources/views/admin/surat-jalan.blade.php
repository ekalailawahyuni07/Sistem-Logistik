...
<head>
    ...
    <style>
        ...
        .stok-table-wrapper::-webkit-scrollbar, .table-responsive::-webkit-scrollbar, .table-scroll::-webkit-scrollbar { width: 5px; height: 5px; }
        .stok-table-wrapper::-webkit-scrollbar-track, .table-responsive::-webkit-scrollbar-track, .table-scroll::-webkit-scrollbar-track { background: #f1f5f9; }
        .stok-table-wrapper::-webkit-scrollbar-thumb, .table-responsive::-webkit-scrollbar-thumb, .table-scroll::-webkit-scrollbar-thumb { background: #cbd5e0; border-radius: 3px; }
