...
<div class="content">
    ...
    <div class="card">
        <div class="card-header-material">
            <h2>Data Material Keluar</h2>

            <a href="{{ route('admin.material.keluar.create') }}" class="btn-tambah">
            ...
            <tbody>
                @forelse($keluar as $item)
                    <tr>
                        ...
                        <td>
                            <a href="{{ route('admin.material.keluar.edit', $item->id_transaksi) }}" class="btn-edit">
                                ✏️ Edit
                            </a>
                        </td>
                    </tr>
