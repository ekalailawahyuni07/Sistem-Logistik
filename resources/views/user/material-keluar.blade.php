...
<div class="content user-page-container">
    ...
    <div class="card">
        <div class="material-card-header">
            <h2>Material Keluar Area {{ Auth::user()->area->nama_area ?? '' }}</h2>

            <div class="material-toolbar">
                <input
                    type="text"
                    id="searchMaterialKeluar"
                    class="material-search"
                    placeholder="🔍 Cari material keluar..."
                    onkeyup="cariMaterialKeluar()"
                >

                <a href="{{ route('material.keluar.create') }}" class="btn-add">
                ...
                <tbody>
                    @forelse($keluar as $item)
                        <tr>
                            ...
                            <td>
                                <a href="{{ route('material.keluar.edit', $item->id_transaksi) }}"
                                class="btn-edit">
                                    ✏️ Edit
                                </a>
                            </td>
