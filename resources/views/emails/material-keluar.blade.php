...
<head>
    <meta charset="UTF-8">
    <title>Notifikasi Material Keluar</title>
</head>
...
<div style="max-width:700px;margin:30px auto;background:#ffffff;border-radius:10px;overflow:hidden;border:1px solid #ddd;">
    ...
    <div style="padding:25px;">
        ...
        <p>
            Terdapat transaksi material keluar baru yang telah disimpan ke sistem.
        </p>
        ...
        <div style="margin-top:25px;padding:15px;background:#fff8e1;border-left:5px solid #f28c28;">
            Periksa kesesuaian data dan surat jalan melalui Sistem MATRILOG.
        </div>
    </div>
